    ...
    <div class="tk-card">
        ...
        <form method="POST" action="{{ route('karyawan.store') }}">
            ...
            <div class="tk-form-body">
                ...
                {{-- ── Salary ── --}}
<div class="tk-section-label">Informasi Gaji</div>
...
<div class="tk-grid">
    <div class="mz-field col-full">
        ...
        <div class="mz-input-wrap" style="position:relative;">
            ...
            <input type="text"
                   value="{{ old('salary') ? number_format((int) old('salary'), 0, ',', '.') : '' }}"
                   placeholder="3.000.000"
                   class="mz-input"
                   style="padding-left:3.5rem;"
                   oninput="var r=this.value.replace(/\D/g,'');this.value=r?r.replace(/\B(?=(\d{3})+(?!\d))/g,'.'):'';document.getElementById('salary_raw').value=r;">

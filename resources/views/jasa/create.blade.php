...
[data-theme="light"] {
   ...
   --mz-accent:   #4f8ef7;
    ...
    .tj-wrap  { font-family: 'Inter', sans-serif; color: var(--mz-text); }
    ...
    .tj-subtitle   { font-size:12px; color:var(--mz-muted); margin-top:5px; max-width:480px; line-height:1.6; }
    ...
    .tj-card {
        ...
        border-radius: 10px;
        overflow: hidden;
        box-shadow: 0 0 0 1px rgba(167,139,250,.07), 0 20px 48px rgba(0,0,0,.4);
    }

    /* purple accent for jasa */
    .tj-card-bar { height: 3px; background: linear-gradient(90deg, var(--mz-purple2), var(--mz-purple), #c4b5fd); }
    ...
    .tj-section-label {
        ...
        text-transform: uppercase; color: var(--mz-purple);
    ...
    .mz-textarea { padding: 12px 14px 12px 38px; resize: vertical; min-height: 100px; }

    .mz-input::placeholder,
    .mz-textarea::placeholder { color: #3a4059; }

    .mz-input:focus, .mz-textarea:focus {
        border-color: var(--mz-purple);
        box-shadow: 0 0 0 3px rgba(167,139,250,.15);
    }
    .mz-input-wrap:focus-within .mz-input-icon { fill: var(--mz-purple); }
    ...
    .mz-textarea-wrap:focus-within .mz-textarea-icon { fill: var(--mz-purple); }
    .mz-textarea-wrap { position: relative; }
    .mz-textarea { padding-left: 38px; }
    ...
    .tj-tip {
        ...
        padding: 12px 14px;
        margin-bottom: 20px;
        font-size: 12px; color: var(--mz-muted); line-height: 1.5;
    }
    .tj-tip svg { width:14px; height:14px; fill:var(--mz-purple); flex-shrink:0; margin-top:1px; }

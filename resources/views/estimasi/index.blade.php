                ...
                <table class="inv-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="td-mobil" style="white-space:normal;min-width:120px">
                                    {{ $e->pelanggan->merk_mobil }} {{ $e->pelanggan->model_mobil }}
                                </div>
                            </td>
                            ...
                            <td class="td-catatan" style="font-size:12px;color:var(--mz-muted)">
                                {{ $e->notes ?? '-' }}
                            </td>

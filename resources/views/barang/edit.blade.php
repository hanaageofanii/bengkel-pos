...
.tb-wrap  { font-family: 'Inter', sans-serif; color: var(--mz-text); }
    ...
    .tb-edit-badge svg { width:11px; height:11px; fill:var(--mz-orange); }
    ...
    /* orange accent bar for edit mode */
    .tb-card-bar { height: 3px; background: linear-gradient(90deg, #e05c00, var(--mz-orange), #f5c542); }
    ...
    .tb-item-chip svg { width:12px; height:12px; fill:var(--mz-yellow); }
